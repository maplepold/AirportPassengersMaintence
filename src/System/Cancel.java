...
public class Cancel extends JFrame { //Sixth
	...
	Cancellation.setFont(new Font("Montserrat", Font.PLAIN, 31));
	...
	PassengerNo.setFont(new Font("Montserrat", Font.PLAIN, 17));
	PassengerNo.setBounds(60, 100, 132, 26);
	add(PassengerNo);
		
	JLabel CancellationNo = new JLabel("CANCELLATION NO");
	CancellationNo.setFont(new Font("Montserrat", Font.PLAIN, 17));
	CancellationNo.setBounds(60, 150, 200, 26);
	add(CancellationNo);
		
	JLabel CancellationDate = new JLabel("CANCELLATION DATE");
	CancellationDate.setFont(new Font("Montserrat", Font.PLAIN, 17));
	CancellationDate.setBounds(60, 200, 180, 26);
	add(CancellationDate);
		
	JLabel Ticketid = new JLabel("TICKET NUMBER");
	Ticketid.setFont(new Font("Montserrat", Font.PLAIN, 17));
	Ticketid.setBounds(60, 250, 150, 26);
	add(Ticketid);
		
	JLabel Flightcode = new JLabel("FLIGHT NUMBER");
	Flightcode.setFont(new Font("Montserrat", Font.PLAIN, 17));
	Flightcode.setBounds(60, 300, 150, 26);
	add(Flightcode);
		
	JButton Cancel = new JButton("CANCEL");
	Cancel.setFont(new Font("Montserrat", Font.PLAIN, 14));
	...
	textField.setBounds(280, 100, 150, 27);
	add(textField);
	
        textField_1 = new JTextField();
	textField_1.setBounds(280, 150, 150, 27);
	add(textField_1);
		
	textField_2 = new JTextField();
	textField_2.setBounds(280, 200, 150, 27);
	add(textField_2);
	
        textField_3 = new JTextField();
	textField_3.setBounds(280, 250, 150, 27);
	add(textField_3);
		
	textField_4 = new JTextField();
	textField_4.setBounds(280, 300, 150, 27);
	add(textField_4);
